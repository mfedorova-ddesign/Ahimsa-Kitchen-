...
export const en: Translations = {
  ...
  planner: {
    ...
    nutrientGoals: {
      ...
      subtitle: 'Calculated from weight, height, sex and activity (Mifflin–St Jeor, reference age 30).',
      weight: 'Weight',
      height: 'Height',
      weightUnit: 'kg',
      heightUnit: 'cm',
      ...
      activityMinimal: 'Low',
      activityMinimalHint: 'Desk work, little exercise',
      activityModerate: 'Moderate',
      activityModerateHint: 'Walking, light workouts 3–4×/week',
      activityAthlete: 'Athlete',
      activityAthleteHint: 'Intense training most days',
      previewTitle: 'Your daily targets',
      previewProtein: 'protein',
      previewCarbs: 'carbs',
      previewFat: 'fat',
      save: 'Save goals',
      reset: 'Reset to default (2000 kcal)',
      customize: 'Customize daily goals',
    },
  },
};
