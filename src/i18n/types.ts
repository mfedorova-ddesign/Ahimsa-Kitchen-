...
export interface Translations {
  ...
  planner: {
    ...
    addProductToMeal: string;
    portionsLabel: string;
    increasePortions: string;
    decreasePortions: string;
    halfPortion: string;
    weightGrams: string;
    perServingWeight: string;
    recipeYield: string;
    ...
    nutrientGoals: {
      ...
      genderMale: string;
      activity: string;
      activityMinimal: string;
      activityMinimalHint: string;
      activityModerate: string;
      activityModerateHint: string;
      activityAthlete: string;
      activityAthleteHint: string;
      previewTitle: string;
      previewProtein: string;
      previewCarbs: string;
      previewFat: string;
      save: string;
      reset: string;
